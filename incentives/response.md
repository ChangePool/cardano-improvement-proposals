...
- While the report concludes that multi-pool operators (MPOs) do not pose a significant risk to the stability of the network, the report ignores the saturation level of pools identified in the MPO category. Operating multiple unsaturated pools instead of a single, larger unsaturated pool betrays the Cardano ecosystem by increasing network centralization. The real harm that MPOs cause to Cardano may not be quantifiable because ADA delegated to an unsaturated MPO is not available to support another potential entrepreneur in the ecosystem, as the design would intend. As Dante (2012) suggests, betrayal may be the ultimate sin.
