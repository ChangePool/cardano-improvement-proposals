...
- While the report concludes that multi-pool operators (MPOs) do not pose a significat risk of destabilizing the network, the report ignores the saturation level of pools identified in the MPO category. Operating multiple unsaturated pools instead of a single, larger unsaturated pool harms and betrays the Cardano ecosystem by increasing network centralization. The actual cost of MPOs to the success of Cardano may not be quantifiable. ADA delegated to an unsaturated MPO is not available to support another potential entrepreneur in the ecosystem, as the design would intend. Betrayal may be the ultimate sin (Dante, 2012).
